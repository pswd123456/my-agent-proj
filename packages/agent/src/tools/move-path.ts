...
export function createMovePathTool(workingDirectory: string): RuntimeTool {
  return {
    name: "move_path",
    description: "Move or rename a workspace file or directory after approval.",
