---
name: skill_creator
description: Create or update workspace skills under .agents/skills with concise, discoverable metadata and stable repo-aware instructions.
---
...
6. Do not invent skills or capabilities that are not present in `.agents/skills/`.
